...
export function registerUserRoutes(app) {
    ...
    app.post('/tour/users/:id/activate', {
        schema: {
            tags: ['Users'],
    ...
    app.post('/tour/users/:id/suspend', {
        schema: {
            tags: ['Users'],
    ...
    app.post('/tour/users/invites/:inviteId/resend', {
        schema: {
            tags: ['Users'],
    ...
    app.post('/tour/users/invites/:inviteId/cancel', {
        schema: {
            tags: ['Users'],
    ...
    app.post('/tour/users/invites/accept', {
        schema: {
            tags: ['Users'],
