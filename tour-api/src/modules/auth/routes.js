...
export function registerAuthRoutes(app) {
    ...
    app.post('/tour/auth/request-reset', {
        schema: {
            tags: ['Authentication'],
    ...
    app.post('/tour/auth/request-reset/resend', {
        schema: {
            tags: ['Authentication'],
    ...
    app.post('/tour/auth/verify-email/request', {
        schema: {
            tags: ['Authentication'],
    ...
    app.post('/tour/auth/verify-email/resend', {
        schema: {
            tags: ['Authentication'],
    ...
    app.post('/tour/auth/verify-email', {
        schema: {
            tags: ['Authentication'],
