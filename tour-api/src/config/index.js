    ...
    await app.register(fastifySwagger, {
        openapi: {
            info: {
                ...
                version: '0.1.0',
                description: 'API for Tour Management System'
            },
            tags: [
                ...
                { name: 'Users', description: 'Manage tour users and invites' },
                { name: 'Drivers', description: 'Manage drivers and their data' },
                { name: 'Departments', description: 'Manage tour departments' },
                ...
                { name: 'Admin', description: 'Administrative operations for tour tenant' }
            ],
            // Swagger-UI extension: group tags into sections
            'x-tagGroups': [
                { name: 'System', tags: ['System'] },
                { name: 'Access', tags: ['Authentication'] },
                { name: 'Organization', tags: ['Users', 'Drivers', 'Departments', 'Roles', 'Permissions'] },
