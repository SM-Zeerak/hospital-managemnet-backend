...
module.exports = {
    async up(queryInterface) {
        ...
        const departmentDefs = [
            ...
            { name: 'Academics', description: 'Academic affairs and curriculum' },
            { name: 'Sports', description: 'Physical education and sports management' },
            { name: 'Transport', description: 'Student transportation services' },
        ...
        // School Permissions (Standard set + any extras)
        ...
        const roleDefs = [
            ...
            },
            {
                ...
                department: 'Administration',
                permissions: allPermissionKeys.filter(k => k !== 'roles.delete')
            },
            {
                name: 'teacher',
                description: 'Class Teacher',
                department: 'Academics',
                permissions: ['dashboard.view', 'students.read', 'classes.read']
            },
            {
                name: 'student',
                description: 'Student',
                department: 'Academics',
                permissions: ['dashboard.view', 'classes.read']
            },
            {
                name: 'parent',
        ...
        // Helper to check existing maps would be good but for brevity we'll insert ignore or careful logic
        // For this seeder, we will fetch existing maps first to avoid duplicates
    ...
    async down(queryInterface) {
        ...
        // Be careful deletions in production, but for dev this is fine
        await queryInterface.bulkDelete('users', { email: 'admin@school.com' }, {});
